...
public class Folders
{
		...
		public static string LogFilesPath
		{
				get
				{
						return Path.Combine(DashboardPath, FOLDER_LOG_FILES);
				}
		}
		public static string TraceFilesPath
		{
				get
				{
						return Path.Combine(DashboardPath, FOLDER_TRACE_FILES);
				}
		}
		public static string UnfinishedSessionsPath
		{
				get
				{
						return Path.Combine(DashboardPath, FOLDER_UNFINISHED_FILES);
				}
		}
